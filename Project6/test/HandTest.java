...
public class HandTest extends TestCase {
    ...
    public void testIsStraight() {
        Card[] cards = {new Card(3,'c'), new Card(4,'h'), new Card(5,'c'), new Card(6,'d'),
                        new Card(7,'s')};
    ...
    public void testHasThreeOfAKind() {
        Card[] cards = {new Card(10,'c'), new Card(4,'h'), new Card(10,'c'), new Card(10,'c'),
                        new Card(14,'c')};
    ...
    public void testHashasTwoPairs() {
        Card[] cards = {new Card(10,'c'), new Card(4,'h'), new Card(10,'c'), new Card(14,'c'),
                        new Card(14,'c')};
        Hand TwoPairs = new Hand(cards);
        assertTrue("TwoPairs hand", TwoPairs.hasTwoPairs());
        assertFalse("Not TwoPairs hand", hand.hasTwoPairs());
    }


    public void testHashasOnePairs() {
        Card[] cards = {new Card(10,'c'), new Card(4,'h'), new Card(10,'h'), new Card(14,'c'),
                        new Card(5,'c')};
        Hand OnePairs = new Hand(cards);
        assertTrue("OnePairs hand", OnePairs.hasOnePair());
        assertFalse("Not OnePairs hand", hand.hasOnePair());
    }

    public void testIsFullHouse() {
        Card[] cards = {new Card(10,'c'), new Card(10,'h'), new Card(10,'s'), new Card(4,'c'),
                        new Card(4,'h')};
        Hand FullHouseHand = new Hand(cards);
        assertTrue("FullHouse hand", FullHouseHand.isFullHouse());
        assertFalse("Not FullHouse hand", hand.isFullHouse());
